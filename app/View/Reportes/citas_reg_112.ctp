<?php     
    ...
    $tcpdf->Ln(5);    
    $tcpdf->Write(0, "REPORTE DE REGISTRO DE CITAS DE ESSALUD EN LINEA - RAJUL\nDEL MES DE ".strtoupper($mes)." DEL ".$anio, '', 0, 'C', true, 0, false, false, 0);
    ...
    $tcpdf->MultiCell(170, 20, "En el Periodo de Enero a Diciembre del ".$anio." las atenciones se dieron de la siguiente manera como puede apreciarse en el Grafico de Barras que se muestra continuacion.", 0, 'J', 1, 1, 20, 45, true, 0, false, true, 40, 'T');
        
    $tcpdf->Cell(56,7, $this->Session->read('cabina'),'LT',0,'C', 1);
    
    $tcpdf->Cell(56,7, 'citas_reg_112',0,0,'C', 1);
