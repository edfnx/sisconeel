<?php $this->set('title_for_layout','Agregar Centro Asistencial de Salud'); ?>
...
<div style="margin-left: 5%; margin-top: 2%; width: 300px; float: bottom; text-align: center; font-size: small;">
    ...
    <div style="text-align: center;">        
        <h1 style="font-size:  small;">Agregar CAS</h1>    
    </div>
    ...
    ?>
    <?php
        echo $this->Form->hidden('Ca.user_id',
                                    array(
    ...
    ?>
    <?php
        echo $this->Form->end('Registrar CAS') 
    ?>
</div>